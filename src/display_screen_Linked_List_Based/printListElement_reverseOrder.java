...
public class printListElement_reverseOrder extends javax.swing.JFrame {
    ...
    public printListElement_reverseOrder() {
        initComponents();
    }

    public printListElement_reverseOrder(node suspect) {
    ...
    private void nextCallActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextCallActionPerformed
        ...
        if (next_halfCheck) {
            printListElement_reverseOrder o = new printListElement_reverseOrder(previousNode(object.getHead(), headRef));
            o.setVisible(true);
        } else {
            printListElement_reverseOrder o = new printListElement_reverseOrder(headRef.getNext());
            o.setVisible(true);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new printListElement_reverseOrder().setVisible(true);
            }
        });
    }
